...
plot(Yrs,Desembarques[1,]/1000, type="b", lwd=2, cex.lab=1, xlab="Año",ylab="Toneladas (miles)", ylim = c(0,max(Desembarques[1,]/1000)*1.1), 
        main="Desembarques")
...
write.csv(LL, paste('Verosimil_',name,'.csv'), row.names = TRUE)
...
write.csv(Variables2, paste('Manejo_',name,'.csv'), row.names = FALSE)
